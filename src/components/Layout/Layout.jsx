    ...
    <>
      ...
      */}
      <div className="min-h-full">
                ...
                <div className="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                  {navigation.map((item) => (
                    <Disclosure.Button
                      ...
                      href={item.href}
                      className={classNames(
                        item.current ? 'bg-zinc-800 text-white' : 'negroText hover:bg-zinc-800 hover:text-white',
                  ...
                  <div className="mt-3 space-y-1 px-2">
                    {userNavigation.map((item) => (
                      <Disclosure.Button
                        ...
                        as="a"
                        href={item.href}
                        className="block rounded-md px-3 py-2 text-base font-medium negroText hover:bg-zinc-800 hover:text-white"
                      >
                        {item.name}
                      </Disclosure.Button>
                    ))}
        ...
        <main>
          <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8 flex flex-wrap blanco">
            <Outlet/>
            </div>
        </main>
      </div>
